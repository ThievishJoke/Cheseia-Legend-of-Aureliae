...
=======
    "Wood" : {
        "Name" : "Wood",
        "Description " : "Wood is a strong and sturdy natural material, rots quickly",
    },
    "stone" : {
        "Description" : "Stone is a hard material from loose rocks"
    },
    "iron" : {
        "Description" : "Iron is a basic metal refined from iron Ore"
    },
    "steel" : {
        "Description" : "Steel is an Alloy of Iron and Coal"
>>>>>>> 6155f5e3ee2f17b7ed2b75eb21205189109dfe40
    },
...
=======
    "Ignitionrot" : {
        "Elemental Affinity" : "Fire",
        "Description" : "The Cheese is cold",
    },
    "Ocean's Breath" : {
        "Elemental Affinity" : "Aqua",
        "Description" : "The Cheese is cold",
    ...
    "Faeroot" : {
        "Name" : "Faeroot",
        "Elemental Affinity" : "Natural",
        "Description" : "Holds Enchantments Well",
    },
    "Aetherwood" : {
        "Elemental Affinity" : "Air",
        "Description" : "The Cheese is cold",
    ...
    "Seashine Ore" : {
        "Elemental Affinity" : "Aqua",
        "Description" : "a luminescent ore that can be found in shallow waters, it is often used to make underwater lights.",
    },
    "Quartzite" : {
        "Elemental Affinity" : "Earth",
        "Description" : "a hard, translucent ore that can be found in underground mines and can be used to create powerful, long-lasting batteries.",
    },
    "Fae Ore" : {
        "Elemental Affinity" : "Natural",
        "Description" : "a glowing green ore that can be found within enchanted glades, it is said to have the power to transport the user to other dimensions.",
    },
    "Stormite" : {
        "Elemental Affinity" : "Air",
        "Description" : "a dark, stormy ore that can be found during thunderstorms, it can be used to create items that generate powerful gusts of wind.",
    },
    "Thunderstone" : {
        "Elemental Affinity" : "Lightning",
        "Description" : "an ore that generates lightning bolts when struck, it can be used to create items that grant the user control over electricity.",
    },
    "Radiant Ore" : {
        "Elemental Affinity" : "Light",
        "Description" : "a glittering ore that can be found in the presence of bright light, it can be used to imbue weapons with the power of the sun.",
    },
    "Prismium" : {
        "Elemental Affinity" : "Light",
        "Description" : "a rainbow-colored ore that can be used to create items that refract light and create dazzling displays.",
    },
    "Starsteel" : {
        "Elemental Affinity" : "Light",
        "Description" : "a rare and precious ore that is said to have fallen from the heavens, it can be used to create weapons with incredible accuracy and precision.",
    },
    "Ebonite Ore" : {
        "Elemental Affinity" : "Dark",
        "Description" : "a jet-black ore that can be used to create weapons that absorb the life force of enemies.",
    },
    "Umbrite Ore" : {
        "Elemental Affinity" : "Eclipse",
        "Description" : "an ore that can only be found during eclipses, it can be used to create items that grant the user the power of darkness and light.",
    },
    "Celestite Ore" : {
        "Elemental Affinity" : "Lunar",
        "Description" : "a pale blue ore that can be found within the stars, it can be used to create items that grant the user the power of the heavens.",
    },
    "Selene Ore" : {
        "Elemental Affinity" : "Lunar",
        "Description" : "a rare and precious ore that can only be found during certain lunar phases, it can be used to create items that grant the user the power of the tides.",
    },
    "Starfall" : {
        "Elemental Affinity" : "Lunar",
        "Description" : "an ore that falls from the sky during meteor showers, it can be used to create items that grant the user the power of the stars.",
    },
    "Necrotite Ore" : {
        "Elemental Affinity" : "Soul",
        "Description" : "a powerful ore that can be found in the presence of death, it can be used to create items that grant the user control over undead creatures.",
    },
    "Anima Ore" : {
        "Elemental Affinity" : "Soul",
        "Description" : "a glowing ore that can be found within places of great spiritual energy, it can be used to create items that grant the user the power of the soul.",
    },
    "Spirit Ore" : {
        "Elemental Affinity" : "Soul",
        "Description" : "an ethereal ore that can be found in places of great emotional significance, it can be used to create items that harness the power of the soul.",
    },
    "Hematite Ore" : {
        "Elemental Affinity" : "Blood",
        "Description" : "a shimmering ore that generates a red liquid when struck, it can be used to create items that grant the user incredible strength.",
    },
    "Crimsonite Ore" : {
        "Elemental Affinity" : "Blood",
        "Description" : "a red ore that can be found in the presence of blood",
    },
    "Vitae Ore" : {
        "Elemental Affinity" : "Blood",
        "Description" : "a rare and precious ore that contains the essence of life, it can be used to create items that grant the user the power to heal wounds and revive the dead.",
    },
    "Carnelian Ore" : {
        "Elemental Affinity" : "Blood",
        "Description" : "a dark red ore that can be found in the presence of bloodshed, it can be used to create items that grant the user incredible speed and agility.",
    }, 
